...
class QR_Code_Settings extends StatefulWidget {
  @override
  _QR_Code_SettingsState createState() => _QR_Code_SettingsState();
}

class _QR_Code_SettingsState extends State<QR_Code_Settings> {
