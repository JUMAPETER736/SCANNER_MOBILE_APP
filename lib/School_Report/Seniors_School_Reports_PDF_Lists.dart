...
// Continue without breaking, as index creation will resolve this
}
}
...
schoolAccount: studentData['schoolAccount'] ?? 'N/A', // Fallback for missing field
...
final uploadTask = await storageRef.putData(pdfBytes); // Direct upload of bytes
...
'schoolAccount': schoolInfoDoc.exists ? (schoolInfoDoc['School_Account'] ?? 'N/A') : 'N/A', // Fallback
};
} catch (e) {
...
//pw.Text('Term: ${Seniors_School_Reports_PDF_List.getCurrentTerm()}', style: pw.TextStyle(font: ttf)),
//pw.Text('Academic Year: ${Seniors_School_Reports_PDF_List.getAcademicYear()}', style: pw.TextStyle(font: ttf)),
pw.SizedBox(height: 20),
